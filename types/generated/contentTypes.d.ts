...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    generationOpportunity: Schema.Attribute.Component<'global.generation-opportunity', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    navItems: Schema.Attribute.Component<'global.nav-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts for Reactor website resources section';
    displayName: 'Post';
    pluralName: 'posts';
    singularName: 'post';
  };
  ...
  attributes: {
    ...
    tableOfContents: Schema.Attribute.Component<'article.toc-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
